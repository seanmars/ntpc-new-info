...
The system SHALL keep the most recent successful response body in memory together with the timestamp of when it was fetched, and SHALL make this snapshot available to API handlers in a thread-safe manner.
